...
public class INF3N212Carro {
                ...
                if (carro == null) {
                    ...
                    do {
                        ...
                        if (proprietario == null) {
                            ...
                            System.out.println("Esse é o proprietário? ");
    ...
    private static void editarPessoa() {
        ...
        do {
            ...
            if (isCPF) {
                ...
                if (p != null) {
                    System.out.println("Quais dads de " + p.getNome() + " deseja alterar?");
    ...
    private static void editarCarro() {
        ...
        do {
            ...
            if (isPlaca) {
                ...
                System.out.println("Dgigite aqui: ");
                int op = leiaNumInt();
                if (op == 1) {
                    isPlaca = true;
                }
    ...
    private static void deletarCarro() {
        ...
        do {
            ...
            String placa = leia.nextLine();
            placa = placa.toUpperCase();
            delCar = Validadores.validarPlaca(placa);
            if (delCar) {
                Carro c = cadCarro.getCarroPlaca(placa);
                if (c != null) {
                    System.out.println("Deseja deletar o Carro de placa " + c.getPlaca() + "?");
                    System.out.print("1 - Sim | 2 - Não: ");
                    int op = leiaNumInt();
                    if (op == 1) {
